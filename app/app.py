...
<body>
    <div class="container">
        <div class="header">
            ...
            <p>Next-Generation DevOps & Deployment Engine</p>
        ...
        <div class="grid">
            <div class="card">
                ...
                <div class="pipeline-step">
                    <div class="step-icon">✓</div> Checkout code
                </div>
                <div class="pipeline-step">
                    <div class="step-icon">✓</div> Install dependencies
                </div>
                <div class="pipeline-step">
                    <div class="step-icon">✓</div> Lint code (flake8)
                </div>
                <div class="pipeline-step">
                    <div class="step-icon">✓</div> Build Docker image
                </div>
                <div class="pipeline-step">
                    <div class="step-icon">✓</div> Push to AWS ECR
                </div>
                <div class="pipeline-step">
                    <div class="step-icon">✓</div> Deploy to EC2
                </div>
            </div>
        ...
        <div class="footer">
            <p>Deployed via GitHub Actions &bull; Hosted on AWS EC2 t3.micro &bull; Infrastructure by Terraform</p>
        </div>
    </div>
</body>
</html>
